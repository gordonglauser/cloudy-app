class FileUploadsController < ApplicationController
  ...
  def delete_multiple
    @uploads = FileUpload.find(params[:file_upload_ids])
    @uploads.each do |file_upload|
      file_upload.destroy!
  end
  ...
  def create
    ...
    if @file_upload.nil?
      flash[:notice] = "File cannot be left blank"
      redirect_to :new_file_upload
    else
    @file_upload.filesize = @file_upload.filelink.size
