...
class FileUploadsControllerTest < ActionController::TestCase
  ...
  test "should create file_upload" do
    assert_difference('FileUpload.count') do
      post :create, file_upload: { filelink: @file_upload.filelink, filesize: @file_upload.filesize, filetype: @file_upload.filetype, name: @file_upload.name }
    end
  ...
  test "should update file_upload" do
    put :update, id: @file_upload, file_upload: { filelink: @file_upload.filelink, filesize: @file_upload.filesize, filetype: @file_upload.filetype, name: @file_upload.name }
    assert_redirected_to file_upload_path(assigns(:file_upload))
  end
